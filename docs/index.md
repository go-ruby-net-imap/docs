# go-ruby-net-imap documentation

**Pure-Go, MRI-4.0.5-faithful Ruby net-imap (no cgo)**

`go-ruby-net-imap/net-imap` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `net-imap`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-net-imap/net-imap`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `net-imap`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`net-imap`](https://github.com/go-ruby-net-imap/net-imap) | the library — Ruby's `net-imap` in pure Go |
| [`docs`](https://github.com/go-ruby-net-imap/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-net-imap.github.io`](https://github.com/go-ruby-net-imap/go-ruby-net-imap.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-net-imap/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-net-imap/net-imap](https://github.com/go-ruby-net-imap/net-imap).
