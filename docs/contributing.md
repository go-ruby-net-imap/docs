...
Contributions are welcome. `go-ruby-net-imap/net-imap` is built to a small set of
...
The library is in [`github.com/go-ruby-net-imap/net-imap`](https://github.com/go-ruby-net-imap/net-imap).
This documentation site is in [`github.com/go-ruby-net-imap/docs`](https://github.com/go-ruby-net-imap/docs).
