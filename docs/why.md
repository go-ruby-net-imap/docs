...
`go-ruby-net-imap/net-imap` reimplements Ruby's `net-imap` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-net-imap/net-imap` directly, with no Ruby runtime;
